...
export const modelInfo = { type:"patio", install:"attached", width: 140, height: 102, length:84, thick:4, gap:0.4, colorHex: colorArr[1].hex, slope:10, roofThick:0.375, roofMat:'clearGlass', left:'none', right:'none', front:'clearGlass', back:'clearGlass', wedge:false, roofShelter:false };
